...
<template>
  <AppPage>
    ...
    >
      <n-card :bordered="false" title="数量限制" content-style="padding-bottom: 0;">
        <n-form-item label="普通用户" path="ali_sms_appcode">
          <n-input />
        </n-form-item>
      </n-card>
      <n-card :bordered="false" title="IOS" content-style="padding-bottom: 0;">
        ...
        <n-form-item label=" ">
          <n-space>
            <n-button strong secondary type="primary" @click="update('alibaba_cloud')">
              提交
            </n-button>
